...
function one(du, u, p, t)
    du[1] = - 0.29*u[1] - 0.66*u[2] + sin(t)
    du[2] = - 0.36*u[1] - 0.29*u[2] + cos(t)
end

function two(du, u, p, t)
    du[1] = - 0.31*u[1] - 0.71*u[2] + sin(0.2*t)
    du[2] = (- 0.15*u[1] - 0.77)*u[2] + cos(0.2*t)
end

const people = Float64[22000, 19000]
const prom1 = [0.0, 3.0]
const prom2 = [0.0, 0.0004]
